...
void loop() {
  ...
  while (!done) {
    ...
    if (Serial.available()) {     
      ...
      if (/*TODO - insert conditional for checking uppercase letters of the variable ch*/) {
        Serial.println(ch);
        flash_morse_code(letters[/*TODO - make sure to index correctly */]);        
      }
      // Check for lowercase letters
      else  if (/*TODO - insert conditional for checking lowercase letters of the variable ch*/) {
        Serial.println(ch);
        flash_morse_code(letters[/*TODO - make sure to index correctly */]);
      }
      // Check for numbers
      else if (/*TODO - insert conditional for checking numbers of the variable ch*/) {
        Serial.println(ch);
        flash_morse_code(numbers[/*TODO - make sure to index correctly */]);
      }
      // Check for space between words
      else if (/*TODO - check if ch is a space */) {
